            ...
            <div class="page-banner home-banner">
                <div class="row align-items-center flex-wrap-reverse h-100">
                    <div class="col-md-6 py-5 wow fadeInLeft">
                        ...
                        <p class="text-lg text-grey mb-5">At VelReact, we craft clean, efficient, and high-performance
                            Laravel applications. Our expertise ensures fast, scalable, and reliable web solutions that
                            stand the test of time. Whether it's a startup or enterprise-level project, we build with
                            precision to keep your site running smoothly and securely. Trust VelReact where quality code
                            meets lasting performance.</p>
                    </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 py-3 wow fadeInUp">
                    ...
                    <p>Velreact Lab is a team of professionals specializing in the development of modern and responsive
                        websites. We leverage Laravel as a robust backend framework, combined with Tailwind CSS,
                        Bootstrap, and JavaScript on the frontend to create elegant and functional user interfaces.</p>
                    <p>Founded by three experts in the field, our team consists of Information Technology graduates with
                        extensive experience in designing efficient, secure, and scalable digital solutions. Velreact
